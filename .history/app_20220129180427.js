var dataTag = document.querySelectorAll("#data-fill");
var dataCopy = document.querySelectorAll("#data-fill-copy");
var arrayOfValue = [];
var numList = [];
var array;
var numArray = [];
...
var col_7 = document.querySelector("#col-7");
...
var col_3_copy = document.querySelector("#col-3-copy");
var col_4_copy = document.querySelector("#col-4-copy");
var col_5_copy = document.querySelector("#col-5-copy");
var col_6_copy = document.querySelector("#col-6-copy");
var col_7_copy = document.querySelector("#col-7-copy");
var col_8_copy = document.querySelector("#col-8-copy");
var col_9_copy = document.querySelector("#col-9-copy");
var dateTag = document.querySelector(".bottom-footer");
var dateTag_copy = document.querySelector(".bottom-footer-copy");
var date = new Date();
...
switch (dayInWeek) {
  case 0:
    ...
    dateTag_copy.innerHTML = `KQXS THÁI BÌNH - CHỦ NHẬT NGÀY ${day}/${month}/${year}`;
    break;
  case 1:
    dateTag.innerHTML = `KQXS THỦ ĐÔ - THỨ HAI NGÀY ${day}/${month}/${year}`;
    dateTag_copy.innerHTML = `KQXS THỦ ĐÔ - THỨ HAI NGÀY ${day}/${month}/${year}`;
    break;
  case 2:
    dateTag.innerHTML = `KQXS QUẢNG NINH - THỨ BA NGÀY ${day}/${month}/${year}`;
    dateTag_copy.innerHTML = `KQXS QUẢNG NINH - THỨ BA NGÀY ${day}/${month}/${year}`;
    break;
  case 3:
    dateTag.innerHTML = `KQXS BẮC NINH - THỨ TƯ NGÀY ${day}/${month}/${year}`;
    dateTag_copy.innerHTML = `KQXS BẮC NINH - THỨ TƯ NGÀY ${day}/${month}/${year}`;
    break;
  case 4:
    dateTag.innerHTML = `KQXS THỦ ĐÔ - THỨ NĂM NGÀY ${day}/${month}/${year}`;
    dateTag_copy.innerHTML = `KQXS THỦ ĐÔ - THỨ NĂM NGÀY ${day}/${month}/${year}`;
    break;
  case 5:
    dateTag.innerHTML = `KQXS HẢI PHÒNG - THỨ SÁU NGÀY ${day}/${month}/${year}`;
    dateTag_copy.innerHTML = `KQXS HẢI PHÒNG - THỨ SÁU NGÀY ${day}/${month}/${year}`;
    break;
  case 6:
    dateTag.innerHTML = `KQXS NAM ĐỊNH - THỨ BẢY NGÀY ${day}/${month}/${year}`;
    dateTag_copy.innerHTML = `KQXS NAM ĐỊNH - THỨ BẢY NGÀY ${day}/${month}/${year}`;
    break;
}
